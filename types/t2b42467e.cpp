/**
 * Definition: t2b42467e
 * Hash: 2b42467e
 */

#include "t2b42467e.h"

void t2b42467e::read(const char* base, char* &ptr) {
  ptr += 8;
  ...
  readData(&unk_fc9d804, base, ptr);
  readData(&unk_8385e16, base, ptr);
  readData(&unk_fd778e6, base, ptr);
}
