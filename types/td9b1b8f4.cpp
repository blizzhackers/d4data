/**
 * Definition: td9b1b8f4
 * Hash: d9b1b8f4
 */

#include "td9b1b8f4.h"

void td9b1b8f4::read(const char* base, char* &ptr) {
  ptr += 8;
  ...
  readData(&unk_c23ffa3, base, ptr);
  readData(&unk_82a430f, base, ptr);
  readData(&unk_41a0826, base, ptr);
  readData(&unk_af999c8, base, ptr);
  readData(&unk_1df004a, base, ptr);
  readData(&unk_6561d12, base, ptr);
  readData(&unk_1d7bcd2, base, ptr);
  readData(&unk_e9859fe, base, ptr);
}
