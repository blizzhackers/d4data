...
void ActorDefinition::read(const char* base, char* &ptr) {
  ...
  current = ptr + 0x100;
  readData(&unk_9c61362, base, current);
  current = ptr + 0x110;
  ...
  current = ptr + 0x190;
  readData(&unk_54868a4, base, current);
  current = ptr + 0x1a0;
  readData(&unk_926b06b, base, current);
  current = ptr + 0x1b0;
  readData(&unk_3960019, base, current);
  current = ptr + 0x1c0;
  readData(&unk_402931f, base, current);
  current = ptr + 0x1d0;
  ...
  current = ptr + 0x200;
  readData(&unk_9c719dc, base, current);
  current = ptr + 0x210;
  readData(&unk_b1fed48, base, current);
  current = ptr + 0x220;
  readData(&unk_c88d583, base, current);
  current = ptr + 0x230;
  readData(&unk_8047aff, base, current);
  current = ptr + 0x240;
  readData(&unk_da0202f, base, current);
  current = ptr + 0x250;
  readData(&unk_ea1a3d1, base, current);
  current = ptr + 0x260;
