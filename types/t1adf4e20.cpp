...
void t1adf4e20::read(const char* base, char* &ptr) {
  ...
  readData(&unk_812c9e9, base, ptr);
  readData(&unk_e91141a, base, ptr);
  readData(&unk_c2ce9c, base, ptr);
  readData(&unk_92ef706, base, ptr);
  readData(&unk_8131b11, base, ptr);
  readData(&unk_545c5ca, base, ptr);
  readData(&unk_1ae9890, base, ptr);
  readData(&unk_c005492, base, ptr);
  readData(&snoSpawnEncounter, base, ptr);
  readData(&snoPopulation, base, ptr);
  readData(&snoSpawnEffect, base, ptr);
  readData(&unk_d32ee25, base, ptr);
  readData(&unk_2820068, base, ptr);
  readData(&unk_50d7e54, base, ptr);
  readData(&snoSpawnItem, base, ptr);
