/**
 * Definition: PortalGizmoData
 * Hash: 656039d2
 */

#include "PortalGizmoData.h"

void PortalGizmoData::read(const char* base, char* &ptr) {
  char *current;
  current = ptr + 0x8;
  ...
  current = ptr + 0xa0;
  readData(&unk_bcb3c09, base, current);
  current = ptr + 0xc0;
  readData(&unk_1e1ad23, base, current);
  ptr += 0xc8;
}
