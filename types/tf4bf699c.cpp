/**
 * Definition: tf4bf699c
 * Hash: f4bf699c
 */

#include "tf4bf699c.h"

void tf4bf699c::read(const char* base, char* &ptr) {
  char *current;
  current = ptr + 0x8;
  ...
  current = ptr + 0xa4;
  readData(&snoDeathPower, base, current);
  current = ptr + 0xa8;
  readData(&unk_306fb69, base, current);
  current = ptr + 0xac;
  readData(&unk_6f5394d, base, current);
  current = ptr + 0xb0;
  readData(&unk_c0f7c, base, current);
  current = ptr + 0xb4;
  readData(&unk_4d93264, base, current);
  ptr += 0xb8;
}
