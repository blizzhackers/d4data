/**
 * Definition: tdddb5e7f
 * Hash: dddb5e7f
 */

#include "tdddb5e7f.h"

void tdddb5e7f::read(const char* base, char* &ptr) {
  char *current;
  current = ptr + 0x8;
  ...
  current = ptr + 0xa0;
  readData(&unk_995096f, base, current);
  current = ptr + 0xa4;
  readData(&unk_6c381bd, base, current);
  current = ptr + 0xa8;
  readData(&unk_b3635f9, base, current);
  current = ptr + 0xb8;
  readData(&unk_1c10eb1, base, current);
  current = ptr + 0xbc;
  readData(&unk_a4fc05b, base, current);
  ptr += 0xc0;
}
