/**
 * Definition: tb8e475b7
 * Hash: b8e475b7
 */

#include "tb8e475b7.h"

void tb8e475b7::read(const char* base, char* &ptr) {
  char *current;
  current = ptr + 0x8;
  ...
  current = ptr + 0xa4;
  readData(&unk_b14a8d7, base, current);
  current = ptr + 0xc8;
  readData(&unk_d9f9ff8, base, current);
  current = ptr + 0xcc;
  readData(&unk_94400f2, base, current);
  current = ptr + 0xd0;
  readData(&unk_2d56a75, base, current);
  current = ptr + 0xd4;
  readData(&unk_51b0c11, base, current);
  current = ptr + 0xd8;
