/**
 * Definition: TriggerEventScreenFade
 * Hash: c2d73f26
 */

#include "TriggerEventScreenFade.h"

void TriggerEventScreenFade::read(const char* base, char* &ptr) {
  char *current;
  current = ptr + 0x8;
  ...
  current = ptr + 0x78;
  readData(&unk_107a24b, base, current);
  ptr += 0x80;
}
