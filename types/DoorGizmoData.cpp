...
#include "DoorGizmoData.h"

void DoorGizmoData::read(const char* base, char* &ptr) {
  char *current;
  current = ptr + 0x8;
  ...
  current = ptr + 0xc4;
  readData(&unk_c23ffa3, base, current);
  current = ptr + 0xc8;
  readData(&unk_82a430f, base, current);
  current = ptr + 0xcc;
  ...
  current = ptr + 0xdc;
  readData(&unk_1d7bcd2, base, current);
  current = ptr + 0xe0;
  readData(&unk_e9859fe, base, current);
  ptr += 0xe8;
}
