...
void t1f7f28b1::read(const char* base, char* &ptr) {
  char *current;
  current = ptr + 0x8;
  ...
  current = ptr + 0xa0;
  readData(&unk_94d8718, base, current);
  current = ptr + 0xa4;
  readData(&unk_4181633, base, current);
  current = ptr + 0xa8;
  readData(&tDestination, base, current);
  current = ptr + 0xb0;
  readData(&unk_c78925f, base, current);
  current = ptr + 0xb4;
  readData(&unk_bdc025, base, current);
  current = ptr + 0xb8;
  readData(&snoLore, base, current);
  current = ptr + 0xbc;
  readData(&unk_13742cd, base, current);
  ptr += 0xc0;
}
