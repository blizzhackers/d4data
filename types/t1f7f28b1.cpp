...
void t1f7f28b1::read(const char* base, char* &ptr) {
  ...
  readData(&unk_94d8718, base, ptr);
  readData(&unk_4181633, base, ptr);
  readData(&tDestination, base, ptr);
  readData(&unk_c78925f, base, ptr);
  readData(&unk_bdc025, base, ptr);
  readData(&snoLore, base, ptr);
  readData(&unk_13742cd, base, ptr);
}
