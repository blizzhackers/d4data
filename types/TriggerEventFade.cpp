/**
 * Definition: TriggerEventFade
 * Hash: c395a246
 */

#include "TriggerEventFade.h"

void TriggerEventFade::read(const char* base, char* &ptr) {
  char *current;
  current = ptr + 0x8;
  ...
  current = ptr + 0x78;
  readData(&unk_e5fd7e1, base, current);
  current = ptr + 0x7c;
  readData(&unk_b49ee2b, base, current);
  current = ptr + 0x80;
