/**
 * Definition: TriggerEventShadowDuration
 * Hash: 20d7a2c2
 */

#include "TriggerEventShadowDuration.h"

void TriggerEventShadowDuration::read(const char* base, char* &ptr) {
  char *current;
  current = ptr + 0x8;
  ...
  current = ptr + 0x7c;
  readData(&unk_b34a8b4, base, current);
  ptr += 0x80;
}
