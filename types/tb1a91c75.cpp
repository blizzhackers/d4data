/**
 * Definition: tb1a91c75
 * Hash: b1a91c75
 */

#include "tb1a91c75.h"

void tb1a91c75::read(const char* base, char* &ptr) {
  char *current;
  current = ptr + 0x8;
  ...
  current = ptr + 0xa0;
  readData(&unk_f937e12, base, current);
  current = ptr + 0xa4;
  readData(&unk_aa86ba7, base, current);
  current = ptr + 0xa8;
  readData(&unk_63192a0, base, current);
  current = ptr + 0xac;
